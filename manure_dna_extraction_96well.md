...
- [ ] Lift the square well mat from pre-filled PowerSoil-htp 96 well plate. Save the mat and lay it upside down on a clean kim-wipe.
    + you can put a kim-wipe on top of the mat to keep dusts or other things to fall on it.     
- [ ] Add 750 µl of PowerSoil
...
- [ ] Check Solution C1. If Solution C1 has precipitated, heat solution at 60ºC until the precipitate has
dissolved.
...
- [ ] Add 60 µl of Solution C1. Secure the Square Well Mat tightly to the plate.     
    ...
    + hover tips over the wells, do not touch. use 8 tips.   
- [ ] Place Bead Plate with mat securely fastened between 2 adapter plates (MO BIO Catalog# 11990)
...
- [ ] Shake at speed 20 for 10 minutes    
    + use program 2 on the Plate Shaker      
- [ ] Re-orient plates so that the side closest to the
machine body is now furthest from the machine body and shake again at speed 20 for 10 minutes.      
    + use program 2 on the Plate Shaker      
- [ ] Centrifuge at room temperature for 6 minutes at 4500 x g(RCF).    
- [ ] Remove and discard the Square Well Mat. Transfer the supernatant (~700µl) to a clean 1 ml Collection Plate.
...
- [ ] Add 250 µl of Solution C2 and apply **Sealing Tape** to plate. Vortex for 5 seconds and incubate at 4ºC
...
- [ ] Avoiding the pellet, transfer entire volume (~800µl) of supernatant to a new 1 ml Collection Plate.    
    + use 8 channel 300µl multichannel pipetteman. Transfer 200µl at a time. Use wellevator for the last transfer.     
    + change tips for each well. use 96 tips.     
- [ ] Apply **Sealing Tape** to plate. Centrifuge the plate again at room temperature for 6 minutes at
4500 x g(RCF). Transfer entire volume (~750µl) of supernatant to another new 1 ml Collection Plate.    
    + use 8 channel 300µl multichannel pipetteman. Transfer 200µl at a time. Use wellevator for the last transfer.     
    + change tips for each well. use 96 tips.     
- [ ] Add 200 µl of Solution C3 and apply **Sealing Tape** to plate. Vortex for 5 seconds and incubate at 4ºC
...
**Sealing Tape**.    
    ...
    + hover over the wells, do not touch. use 8 tips.    
- [ ] Avoiding the pellet, transfer entire volume (~750µl) of supernatant to a new 1 ml Collection Plate.     
    + use 8 channel 300µl multichannel pipetteman. Transfer 200µl at a time. Use wellevator for the last transfer.     
    + change tips for each well. use 96 tips.      
- [ ] Apply **Sealing Tape** to plate. Centrifuge the plate again at room temperature for 6 minutes at
4500 x g(RCF).     
- [ ] Transfer no more than 650 µl of supernatant to a 2 ml Collection Plate avoiding any residual pellet.    
    + use 8 channel 300µl multichannel pipetteman. Transfer 200µl at a time. Use wellevator for the last transfer.     
    + change tips for each well. use 96 tips.           
...
- [ ] Add a second 650 µl of Solution C4 to each well of the plate.
    + use E1 Clip-tip 1250µl, program `Htp-650µl`     
    + It is safe to stop the protocol at this step and store the samples covered with
**Sealing Tape** at 4°C.     
- [ ] Place Spin Plate onto a new 0.5 ml Collection Plate.     
- [ ] Pipet samples “up and down” to mix. Load 650 µl into each well of the Spin Plate and apply **Centrifuge Tape**.     
...
- [ ] Centrifuge at room temperature for 3 minutes at 4500 x g(RCF). Discard the flow through and place the
...
- [ ] Repeat steps 20-21 until all the supernatant has been processed. Discard the final flow through.    
- [ ] Place the Spin Plate back on the **same** 0.5 ml Collection Plate.   
- [ ] Confirm that ethanol has been added to Solution C5-D (see note). Add 500 µl of Solution C5-D
...
- [ ] Centrifuge again at room temperature for 5 minutes at 4500 x g(RCF). Discard the flow through.    
- [ ] Carefully place the Spin Plate onto a Microplate. Remove **Centrifuge Tape** and discard.     
- [ ] Allow to air dry for 10 minutes at room temperature.     
- [ ] Add 100 µl of Solution C6 to the center of each well of the Spin Plate. Apply **Centrifuge Tape**.     
...
- [ ] Centrifuge at room temperature for 3 minutes at 4500 x g(RCF). Remove **Centrifuge Tape** and discard.    
- [ ] Cover the wells of Microplate with the **Elution Sealing Mat** provided. DNA is now ready for any      
